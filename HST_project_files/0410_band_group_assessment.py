...
gswlc = numpy.genfromtxt('data/crossmatch_GSW.dat', names=True)
gswlc_int = numpy.genfromtxt('data/crossmatch_GSW.dat', names=True, dtype=numpy.uint64)
...
plt.ylim(-0.6, 0.6)
plt.savefig('Plots/analysis/kcorr_other/totaln.png', bbox_inches='tight')
plt.show()
plt.close()
...
ax.yaxis.set_tick_params(direction='in', size=4, left=True, right=True, which='minor', labelsize=16)
plt.ylim(-0.6, 0.6)
plt.savefig('Plots/analysis/kcorr_other/totaln_mags.png', bbox_inches='tight')
plt.show()
plt.close()
...
ax.yaxis.set_tick_params(direction='in', size=4, left=True, right=True, which='minor', labelsize=16)
plt.ylim(-0.6, 0.6)
plt.savefig('Plots/analysis/kcorr_other/R50.png', bbox_inches='tight')
plt.show()
plt.close()
...
ax.yaxis.set_tick_params(direction='in', size=4, left=True, right=True, which='minor', labelsize=16)
plt.ylim(-0.6, 0.6)
plt.savefig('Plots/analysis/kcorr_other/R50_mags.png', bbox_inches='tight')
plt.show()
plt.close()
...
ax.yaxis.set_tick_params(direction='in', size=4, left=True, right=True, which='minor', labelsize=16)
plt.ylim(-1, 1)
plt.savefig('Plots/analysis/kcorr_other/BTn4.png', bbox_inches='tight')
plt.show()
plt.close()
...
ax.yaxis.set_tick_params(direction='in', size=4, left=True, right=True, which='minor', labelsize=16)
plt.ylim(-1, 1)
plt.savefig('Plots/analysis/kcorr_other/BTn4_mags.png', bbox_inches='tight')
plt.show()
plt.close()
...
ax.yaxis.set_tick_params(direction='in', size=4, left=True, right=True, which='minor', labelsize=16)
plt.ylim(-1, 1)
plt.savefig('Plots/analysis/kcorr_other/BTnf.png', bbox_inches='tight')
plt.show()
plt.close()
...
ax.yaxis.set_tick_params(direction='in', size=4, left=True, right=True, which='minor', labelsize=16)
plt.ylim(-1, 1)
plt.savefig('Plots/analysis/kcorr_other/BTnf_mags.png', bbox_inches='tight')
plt.show()
plt.close()
...
ax.yaxis.set_tick_params(direction='in', size=4, left=True, right=True, which='minor', labelsize=16)
plt.ylim(-1, 1)
plt.savefig('Plots/analysis/kcorr_other/nb.png', bbox_inches='tight')
plt.show()
plt.close()
...
ax.yaxis.set_tick_params(direction='in', size=4, left=True, right=True, which='minor', labelsize=16)
plt.ylim(-1, 1)
plt.savefig('Plots/analysis/kcorr_other/nb_mags.png', bbox_inches='tight')
plt.show()
plt.close()"""
