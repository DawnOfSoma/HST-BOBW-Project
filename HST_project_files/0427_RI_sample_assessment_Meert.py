...
gswlc = numpy.genfromtxt('data/crossmatch_GSW_Meert_inclusive.dat', names=True)
gswlc_int = numpy.genfromtxt('data/crossmatch_GSW_Meert_inclusive.dat', names=True, dtype=numpy.uint64)
...
plt.ylabel('log $n$ (Meert)', size=18)
...
plt.savefig('Plots/analysis/RI_sample_MEERT/totaln_1to1_Meert_vs_hst.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()
...
plt.ylabel('log $n_{bulge}$ (Meert)', size=18)
medbins = numpy.arange(start=-0.3, stop=1, step=0.1)
medrange = (-0.3, 0.9)
...
plt.savefig('Plots/analysis/RI_sample_MEERT/bulgen_1to1_Meert_vs_hst.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()
...
plt.ylabel('B/T 4+1 (Meert)', size=18)
...
plt.text(y=0.175, x=0.65, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
plt.text(y=0.075, x=0.65, s='$\Delta$ = {}'.format(round(numpy.nanmedian(td),2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/BTn4_1to1_Meert_vs_hst.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()
...
plt.ylabel('B/T n+1 (Meert)', size=18)
medbins = numpy.arange(start=0, stop=1.05, step=0.05)
medrange = (0, 1)
...
plt.text(y=0.175, x=0.65, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
plt.text(y=0.075, x=0.65, s='$\Delta$ = {}'.format(round(numpy.nanmedian(td),2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/BTnf_1to1_Meert_vs_hst.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()
...
plt.ylabel('log $R_{eff}$ (Meert) [kpc]', size=18)
...
plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(numpy.nanmedian(td),2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/R50_1to1_Meert_vs_hst.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()
...
plt.ylabel('$\Delta$ log $n$ (Meert - HST)', size=18)
plt.xlabel('B/T n+1 (HST)', size=18)
...
plt.savefig('Plots/analysis/RI_sample_MEERT/delta_totaln_vs_BTnf.png', bbox_inches='tight')
plt.show()
plt.close()
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/delta_totaln_vs_R50.png', bbox_inches='tight')
plt.show()
plt.close()
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/delta_totaln_vs_mstar.png', bbox_inches='tight')
plt.show()
plt.close()
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/delta_totaln_vs_ssfr.png', bbox_inches='tight')
plt.show()
plt.close()
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/delta_ssfr_totaln.png', bbox_inches='tight')
plt.show()
plt.close()
...
plt.ylabel('$\Delta$ log $n_{bulge}$ (Meert - HST)', size=18)
plt.xlabel('$\Delta$ log sSFR', size=18)
plt.axhline(y=0, c='k', linestyle='-', linewidth=1)
plt.plot(bin_centers, medians, c='r', linestyle='-', linewidth=2)
ax = plt.gca()
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/delta_ssfr_nbulge.png', bbox_inches='tight')
plt.show()
plt.close()
...
plt.ylabel('$\Delta$ B/T 4+1 (Meert - HST)', size=18)
plt.xlabel('$\Delta$ log sSFR', size=18)
plt.axhline(y=0, c='k', linestyle='-', linewidth=1)
plt.plot(bin_centers, medians, c='r', linestyle='-', linewidth=2)
ax = plt.gca()
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/delta_ssfr_BTn4.png', bbox_inches='tight')
plt.show()
plt.close()
...
plt.ylabel('$\Delta$ B/T n+1 (Meert - HST)', size=18)
plt.xlabel('$\Delta$ log sSFR', size=18)
plt.axhline(y=0, c='k', linestyle='-', linewidth=1)
plt.plot(bin_centers, medians, c='r', linestyle='-', linewidth=2)
ax = plt.gca()
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/delta_ssfr_BTnf.png', bbox_inches='tight')#, format='pdf', dpi=500)
plt.show()
plt.close()
...
medrange = (-4, 2)
medians, bin_edges, binnumber = binned_statistic(x=delta_ssfr[ri_BTnf > -99.], values=ri_BTnf_sim[ri_BTnf > -99.], statistic='median', bins=medbins, range=medrange)
bin_width = (bin_edges[1] - bin_edges[0])
bin_centers = bin_edges[1:] - bin_width/2
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/BTnf_vs_ssfr_meert.png', bbox_inches='tight')
plt.show()
plt.close()

medbins = [-4, -3, -2, -1, -0.5, 0, 0.5, 1, 2]
medrange = (-4, 2)
medians, bin_edges, binnumber = binned_statistic(x=delta_ssfr[ri_BTnf > -99.], values=ri_BTn4_sim[ri_BTnf > -99.], statistic='median', bins=medbins, range=medrange)
bin_width = (bin_edges[1] - bin_edges[0])
bin_centers = bin_edges[1:] - bin_width/2
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/BTn4_vs_ssfr_meert.png', bbox_inches='tight')
plt.show()
plt.close()
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/nbulge_vs_ssfr_meert.png', bbox_inches='tight')
plt.show()
plt.close()
...
#plt.text(x=0.075, y=0.875, s='$\sigma$ = {}'.format(round(sigma,2)), fontsize=16, transform=ax.transAxes)
#plt.text(x=0.075, y=0.775, s='$\Delta$ = {}'.format(round(median,2)), fontsize=16, transform=ax.transAxes)
plt.savefig('Plots/analysis/RI_sample_MEERT/totaln_vs_ssfr_meert.png', bbox_inches='tight')
plt.show()
plt.close()