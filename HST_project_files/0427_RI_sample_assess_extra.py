# -*- coding: utf-8 -*-
"""
Created on Mon May 29 17:43:32 2023
...
for i in range(0,len(unique_ids)):
    ...
    if unique_ids[i] not in used_ids and has_ri_filters:
        ...
        #if weighted_mean(all_BTnf, all_weight) > 0.3 and weighted_mean(all_BTnf, all_weight) < 0.7: #and ssfr > -10.5 and ssfr < -9.5:
...
#plt.plot(medians, bin_centers, c='r', linestyle='-', linewidth=2)

#td = numpy.log10(ri_nb) - numpy.log10(ri_n)
#td = td[td > -99.]
...
plt.scatter(numpy.log10(ri_n), numpy.log10(ri_nb), s=8, c='b')
...
plt.savefig('Plots/analysis/RI_sample/nbulge_versus_totaln.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()

plt.figure(figsize=(4,4))
plt.scatter(numpy.log10(ri_n_sim), numpy.log10(ri_nb_sim), s=8, c='b')
plt.plot(x1to1, x1to1, 'k-', linewidth=1)
...
plt.ylim(-0.5, 1)
ax.set_aspect('equal', 'box')
plt.savefig('Plots/analysis/RI_sample/nbulge_versus_totaln_SIMARD.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()

plt.figure(figsize=(4,4))
plt.scatter(numpy.log10(ri_n), ri_BTn4, s=8, c='b')
plt.xlabel('log $n$ (HST)', size=18)
...
ax.xaxis.set_tick_params(direction='in', size=10, top=True, bottom=True, which='major', labelsize=16)
ax.xaxis.set_tick_params(direction='in', size=4, top=True, bottom=True, which='minor', labelsize=16)
major_yticks = [0, 0.25, 0.5, 0.75, 1]
...
plt.xlim(-0.5, 1)
plt.ylim(0, 1)
plt.savefig('Plots/analysis/RI_sample/BTn4_versus_totaln.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()

plt.figure(figsize=(4,4))
plt.scatter(numpy.log10(ri_n_sim), ri_BTn4_sim, s=8, c='b')
plt.xlabel('log $n$ (Simard)', size=18)
...
plt.xlim(-0.5, 1)
plt.ylim(0, 1)
plt.savefig('Plots/analysis/RI_sample/BTn4_versus_totaln_SIMARD.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()

plt.figure(figsize=(4,4))
plt.scatter(numpy.log10(ri_n), ri_BTnf, s=8, c='b')
plt.xlabel('log $n$ (HST)', size=18)
...
plt.xlim(-0.5, 1)
plt.ylim(0, 1)
plt.savefig('Plots/analysis/RI_sample/BTnf_versus_totaln.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()

plt.figure(figsize=(4,4))
plt.scatter(numpy.log10(ri_n_sim), ri_BTnf_sim, s=8, c='b')
plt.xlabel('log $n$ (Simard)', size=18)
...
plt.xlim(-0.5, 1)
plt.ylim(0, 1)
plt.savefig('Plots/analysis/RI_sample/BTnf_versus_totaln_SIMARD.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()

plt.figure(figsize=(4,4))
plt.scatter(numpy.log10(ri_n), numpy.log10(ri_Reff), s=8, c='b')
plt.xlabel('log $n$ (HST)', size=18)
plt.ylabel('log $R_{eff}$ (HST)', size=18)
ax = plt.gca()
major_xticks = [-0.5, 0.0, 0.5, 1.]
ax.set_xticks(major_xticks)
ax.xaxis.set_minor_locator(AutoMinorLocator())
...
plt.xlim(-0.5, 1)
plt.ylim(-1, 2.5)
plt.savefig('Plots/analysis/RI_sample/R50_versus_totaln.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()

plt.figure(figsize=(4,4))
plt.scatter(numpy.log10(ri_n_sim), numpy.log10(ri_Reff_sim), s=8, c='b')
plt.xlabel('log $n$ (Simard)', size=18)
plt.ylabel('log $R_{eff}$ (Simard)', size=18)
ax = plt.gca()
major_xticks = [-0.5, 0.0, 0.5, 1.]
ax.set_xticks(major_xticks)
ax.xaxis.set_minor_locator(AutoMinorLocator())
...
plt.xlim(-0.5, 1)
plt.ylim(-1, 2.5)
plt.savefig('Plots/analysis/RI_sample/R50_versus_totaln_SIMARD.pdf', bbox_inches='tight', format='pdf', dpi=500)
plt.show()
plt.close()