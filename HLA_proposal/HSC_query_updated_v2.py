    ...
    for i in range(0,len(n)):
        ...
        if sdss_id not in used_IDs and sdss_id in subsample:
            ...
            if found_image:
                ...
                HST_plot = fig.add_axes([0.2, 0.0, 1.0, 1.0])
                ...
                while not download_successful:
                    try:
                        ...
                        for path in paths:
                            ...
                            SDSS_plot = fig.add_axes([-0.5, 0.0, 1.0, 1.0])
            ...
            fig.suptitle('z = {}, log $M_*$ = {}, log sSFR = {}, n = {}'.format(round(mz,2), round(mMstar,1), round(mSSFR,1), round(mn,1)), size=24, y=1.1, x=0.35)
            fig.savefig('images/{}_combined.png'.format(sdss_id), bbox_inches = "tight", dpi=500)
            fig.clf()
